...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" class="form-control bootstrap-timepicker-hour" style="padding: 0px;" maxlength="2"/>';
        minuteTemplate = '<input type="text" class="form-control bootstrap-timepicker-minute" style="padding: 0px;" maxlength="2"/>';
        secondTemplate = '<input type="text" class="form-control bootstrap-timepicker-second" style="padding: 0px;" maxlength="2"/>';
        meridianTemplate = '<input type="text" class="form-control bootstrap-timepicker-meridian" style="padding: 0px;" maxlength="2"/>';
      } else {
